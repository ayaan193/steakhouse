        ...
        return (
          <button
            ...
            className={`
              ...
              ${isActive ? "text-[#f0a81e]" : "text-white/60 hover:text-white"}
            `}
          >
            {isActive && (
              <span
...
export default function Menu1() {
  ...
  // Show sticky sub-nav once the hero scrolls out of view
  useEffect(() => {
  ...
  // Blur food image on upward scroll
  useEffect(() => {
    ...
    <div className="bg-[#15110d]">
      ...
      <section ref={heroRef} className="relative h-screen overflow-hidden">
        ...
        <div
          ...
          style={{ background: "linear-gradient(180deg, rgba(8,6,4,0.65), transparent)" }}
        />
        <div
          className="absolute inset-0 pointer-events-none"
          style={{ background: "radial-gradient(110% 70% at 50% 40%, transparent, rgba(0,0,0,0.38))" }}
        />
        <div
          className="absolute inset-x-0 bottom-0 pointer-events-none"
          style={{
            height: "45%",
            background: "linear-gradient(0deg, rgba(8,6,4,0.88), rgba(8,6,4,0.30) 55%, transparent)",
          }}
        />
        ...
        <div className="absolute bottom-0 inset-x-0 z-10 flex items-center border-t border-white/12">
          <div
            ...
            style={{
              ...
              background: "linear-gradient(to top, rgba(8,6,4,0.72), rgba(8,6,4,0.18))",
            }}
          />
